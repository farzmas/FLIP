...
def parameter_parser():
	...
	parser.add_argument("--task",
					nargs = "?",
					default = "all",
				help = "task to do options: all, walk, embd, lp. Default is all.")
	...
	parser.add_argument("--embedding-path", nargs = "?", 
						default = "/data/Farzan/Fairness/embds/",
	...
	parser.add_argument("--learning-rate",
						type = float,
						default = 0.001,
					help = "Gradient descent learning rate. Default is 0.005.")
	parser.add_argument("--beta-g",
						type = float,
						default = 0.9,
					help = "generator hyperparameter. Default is 0.5")

	parser.add_argument("--beta-d",
						type = float,
						default = 0.1,
					help = "discriminator hyperparameter. Default is 0.5")
